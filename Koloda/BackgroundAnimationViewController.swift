...
extension BackgroundAnimationViewController: KolodaViewDataSource {
    ...
    func koloda(koloda: KolodaView, viewForCardAtIndex index: UInt) -> UIView {
        ...
        designNameLabel.font = UIFont(name: "Courier", size: 30)
    
        
        //create UIView for artist attribution
        let artistAttributionView = UIView(frame: CGRectMake(mainView.bounds.size.width / 4, mainView.bounds.size.height - 70, mainView.bounds.size.width / 2, 50))
